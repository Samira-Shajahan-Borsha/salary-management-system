...
class SeniorSalesperson extends Salesperson implements Bonus{
 ...
 public  double  calculateSalary () throws ZeroResultException {
	...
	System.out.println("sal"+salperhr);
...
public  class  Salaries{
 ...
 int exit1=0;
	do{
 System.out.println("Choose: Add Employee - a, Update SalaryPerHour - b, Display Employees - c, Exit -d");  
 char ch = sc.next().charAt(0);
 switch(ch){
	 case 'a' :
	 int exit2=0;
		 do{
	      System.out.println("Choose position of the Employee: ");
	      System.out.println("Manager - a, Receptionist - b, Salesperson - c, Accountant - d,") ;
	      System.out.println("SeniorSalesperson - e, SeniorAccountant - f, Exit -g");
	      ...
	      switch(ch1){
		    ...
		    case 'e' :
			  ...
			  System.out.println("Caught exception - hours cannot be negative");
				 ...
				 System.out.println("Age must be greater than 35");
			 }
				break;
			case 'f' :
     ...
     case 'b' :
		int exit3 = 0;
		do{
	   	System.out.println("Choose Employee position  you want to update salary per hour");
		System.out.println("Manager - a, Receptionist - b, Salesperson - c, Accountant - d, Exit - e");
